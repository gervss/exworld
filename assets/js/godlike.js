...
function runParallaxMouse(x, y) {
  ...
  $parallaxMouseList.each(function eachParallaxMouse() {
    ...
    _utility__WEBPACK_IMPORTED_MODULE_0__["tween"].to(this, data.speed, {
      x: itemX * maxOffset,
      y: itemY * maxOffset,
      force3D: true
    });
...
function initPreloader() {
  ...
  self.closePreloader = function closePreloader(cb) {
    if (!isBusy && isOpened) {
      ...
      if (!closeData.loaded) {
        _utility__WEBPACK_IMPORTED_MODULE_0__["tween"].to($preloader, 0.3, {
          opacity: 0,
          display: 'none',
          force3D: true,
      ...
      _utility__WEBPACK_IMPORTED_MODULE_0__["tween"].to($preloaderBG, closeData.speed, {
      ...
      _utility__WEBPACK_IMPORTED_MODULE_0__["tween"].to($content, 0.3, {
        y: '-20px',
        opacity: 0,
        display: 'none',
        force3D: true
...
function initNavbarDropEffect1() {
  ...
  function toggleSubmenu(open, $drop) {
    ...
    _utility__WEBPACK_IMPORTED_MODULE_0__["tween"].to($newItems, 0.3, {
      x: '0%',
      rotationY: '0deg',
      opacity: 1,
      delay: 0.1
    ...
    _utility__WEBPACK_IMPORTED_MODULE_0__["tween"].to($oldItems, 0.3, {
      x: open ? '-30%' : '30%',
      rotationY: open ? '-30deg' : '30deg',
      opacity: 0,
      onComplete: function onComplete() {
...
function initSearchBlock() {
  ...
  self.openSearch = function () {
    ...
    _utility__WEBPACK_IMPORTED_MODULE_0__["tween"].to($search, 0.5, {
      opacity: 1,
      display: 'block',
      force3D: true
    });
    _utility__WEBPACK_IMPORTED_MODULE_0__["tween"].to($searchField, 0.3, {
      y: 0,
      opacity: 1,
      delay: 0.2,
      force3D: true
...
function initCart() {
  ...
  self.openCart = function () {
    ...
    _utility__WEBPACK_IMPORTED_MODULE_0__["tween"].to($cart, 0.5, {
      opacity: 1,
      display: 'block',
      force3D: true
    });
    _utility__WEBPACK_IMPORTED_MODULE_0__["tween"].staggerTo($cartItems, 0.3, {
      y: 0,
      opacity: 1,
      delay: 0.2
    }, 0.1);
    _utility__WEBPACK_IMPORTED_MODULE_0__["tween"].to($cartTotal, 0.3, {
      y: 0,
      opacity: 1,
      delay: 0.3,
      force3D: true
    });
    _utility__WEBPACK_IMPORTED_MODULE_0__["tween"].to($cartBtns, 0.3, {
      y: 0,
      opacity: 1,
      delay: 0.4,
      force3D: true
...
function initSignForm() {
  ...
  self.openSignForm = function () {
    ...
    _utility__WEBPACK_IMPORTED_MODULE_0__["tween"].to($signForm, 0.5, {
      opacity: 1,
      display: 'block',
      force3D: true
    });
    _utility__WEBPACK_IMPORTED_MODULE_0__["tween"].to($signFormContainer, 0.3, {
      y: 0,
      opacity: 1,
      delay: 0.4,
      force3D: true
...
function initActionsLike() {
  ...
  function runLikeAnimation(type) {
    ...
    _utility__WEBPACK_IMPORTED_MODULE_0__["tween"].to($animateItem, 0.3, {
      scale: 1.1,
      opacity: 0.5,
      display: 'block',
      ease: Power2.easeIn,
...
function initCookieAlert() {
  ...
  function hideAlert() {
    _utility__WEBPACK_IMPORTED_MODULE_0__["tween"].to($alert, 0.5, {
      opacity: 0,
      display: 'none'
    });
  } // show alert
